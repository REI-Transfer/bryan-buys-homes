...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen bg-gray-50">
      ...
      <TrackingCapture />
      {/* Minimal white header — logo only (OC v3 zero-distraction look). No VSL. */}
      ...
      <div className="mx-auto max-w-xl px-4 pt-6 pb-12 md:pt-10">
        {/* Centered hero — copy stays config-driven (Lori's HEADLINE / SUBHEADLINE) */}
        ...
        {/* OC v3 zero-distraction form as the primary funnel (no video / VSL). */}
        <ZeroDistractionForm
